  ...
  return (
    ...
    <li >Highlight 5</li>
      ...
      <div className="text-13 text-dark-1">
        <div className="fw-500">3 - Months from <span class="text-dark-4">LKR 96,633.33</span></div>
      </div>
      <div className="text-13 text-dark-1">
        <div className="fw-500">6 - Months from <span class="text-dark-4">LKR 48,316.67</span></div>
      </div>
      <div className="text-13 text-dark-1">
        <div className="fw-500">9 - Months from <span class="text-dark-4">LKR 32,211.11</span></div>
      </div>
      </div>
      </div>
