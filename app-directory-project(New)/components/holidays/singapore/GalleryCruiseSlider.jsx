...
const GalleryCruiseSlider = () => {
  ...
  const galleryImage = [
    "/img/holidays/singapore/1.png",
    "/img/holidays/singapore/2.png",
    "/img/holidays/singapore/3.png",
    "/img/holidays/singapore/4.png",
    "/img/holidays/singapore/5.png",
    "/img/holidays/singapore/6.png",
  ];
