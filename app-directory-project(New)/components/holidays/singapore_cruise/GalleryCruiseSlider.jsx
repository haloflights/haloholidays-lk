...
const GalleryCruiseSlider = () => {
  ...
  const galleryImage = [
    "/img/holidays/singapore_cruise/1.png",
    "/img/holidays/singapore_cruise/2.png",
    "/img/holidays/singapore_cruise/3.png",
    "/img/holidays/singapore_cruise/4.png",
    "/img/holidays/singapore_cruise/5.png",
    "/img/holidays/singapore_cruise/6.png",
  ];
