...
const GalleryCruiseSlider = () => {
  ...
  const galleryImage = [
    "/img/holidays/bangkok_and_phuket/1.png",
    "/img/holidays/bangkok_and_phuket/2.png",
    "/img/holidays/bangkok_and_phuket/3.png",
    "/img/holidays/bangkok_and_phuket/4.png",
    "/img/holidays/bangkok_and_phuket/5.png",
    "/img/holidays/bangkok_and_phuket/6.png",
  ];
