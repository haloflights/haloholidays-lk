...
const GalleryCruiseSlider = () => {
  ...
  const galleryImage = [
    "/img/holidays/maldives/1.png",
    "/img/holidays/maldives/2.png",
    "/img/holidays/maldives/3.png",
    "/img/holidays/maldives/4.png",
    "/img/holidays/maldives/5.png",
    "/img/holidays/maldives/6.png",
  ];
